...
import '../assets/styles/LandingAnimation.css';
...
class LandingAnimation extends Component{
    ...
    render(){
        return( 
            <div className="bb flex-column">
            <svg version="1.1" id="home-anim" xmlns="http://www.w3.org/2000/svg" height="100vh" width="100vw" x="0px" y="0px" viewBox="0 0 100vw 100vh">
